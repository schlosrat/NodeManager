...
public class NodeManagerPlugin : BaseSpaceWarpPlugin
{
    ...
    private static readonly int windowHeight = 320;
    ...
    private static Rect closeBtnRect;
    ...
    private static void FillWindow(int windowID)
    {
        ...
        GUILayout.Label("Node Manager - Provides services for other mods needing to create, delete, and manage maneuver nodes");
    ...
    private static bool CloseButton()
    {
    ...
    public static void CreateManeuverNodeAtUT(Vector3d burnVector, double UT, double burnDurationOffsetFactor = -0.5)
    {
        ...
        {
            nodeData = new ManeuverNodeData(activeVessel.SimulationObject.GlobalId, false, UT);
        }
        else
        {
            ...
            {
                nodeData = new ManeuverNodeData(activeVessel.SimulationObject.GlobalId, true, UT);
                orbit.PatchEndTransition = PatchTransitionType.Final;
            }
